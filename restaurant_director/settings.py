"""
Django settings for restaurant_director_02 project.
...
ROOT_URLCONF = 'restaurant_director_02.urls'
...
WSGI_APPLICATION = 'restaurant_director_02.wsgi.application'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'restaurant_director_02/static')
]
STATIC_URL = 'static/'
